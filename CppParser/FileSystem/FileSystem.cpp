...
int main(int argc, char* argv[])
{
  ...
  std::string fs = Path::fileSpec(".","temp.textbox");
  std::cout << "\n  Path::fileSpec(\".\",\"temp.textbox\") = " << fs;
  ...
  std::string upper = Path::toUpper("temp.textbox");
  std::cout << "\n  Path::toUpper(\"temp.textbox\") = " << upper;

  std::string lower = Path::toLower("Temp.textbox");
  std::cout << "\n  Path::toLower(\"Temp.textbox\") = " << lower;
  std::cout << std::endl;
  ...
  std::cout << "\n  .textbox files residing in C:/temp are:";
  currfiles = Directory::getFiles("c:/temp/", "*.textbox");
  ...
  files.push_back("../FileSystemTest.textbox");              // file in solution directory
  ...
  std::cout << "\n";
  File testAll("../FileSystemTest.textbox");
  ...
  std::cout << "\n";
  File testAllTrue("../FileSystemTest.textbox");
  ...
  title("writing to c:/temp/test.textbox", '-');
  File in("../FileSystemDemo/FileSystem.h");
  in.open(File::in, File::text);
  File out("c:/temp/test.textbox");
  ...
  std::cout << "\n  check c:/temp/test.textbox to validate";
  std::cout << "\n\n";
